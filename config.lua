...
Config.Rewards = {
    [1] = {
        ...
        ["chest"] = {"plastic", "rolex", "diamond_ring", "goldchain", "weed_skunk", "cryptostick", "weapon_pistol"},
        ["livingroom"] = {"plastic", "rolex", "diamond_ring", "goldchain", "cryptostick", "tablet", "pistol_ammo"}
    }
}
